...
.ct-info__item-tekst { font-size: 14px; color: #6b7280; margin: 0; line-height: 1.6; }
...
.ct-form__input,
.ct-form__textarea {
    background: #f9f7f3; border: 1.5px solid #ece9e3; border-radius: 10px;
...
.ct-form__textarea:focus { border-color: #8b7355; }
...
.ct-dropdown__toggle.selected { color: #1a1a1a; }
.ct-dropdown.open .ct-dropdown__toggle,
.ct-dropdown__toggle:focus { border-color: #8b7355; outline: none; }
.ct-dropdown__toggle i { font-size: 12px; color: #b0a898; transition: transform 0.2s; flex-shrink: 0; }
.ct-dropdown.open .ct-dropdown__toggle i { transform: rotate(180deg); }

.ct-dropdown__menu {
    display: none; position: absolute; top: calc(100% + 6px); left: 0; right: 0;
    background: #fff; border: 1.5px solid #e2ddd5; border-radius: 12px;
...
.ct-form__btn:hover { background: #333; transform: translateY(-2px); }
